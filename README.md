...
> [!NOTE]
> **Docker-based providers** run locally on your machine for free. They work on CPU (very slow) or with <img src="internal/nvidia.svg" height="16"> GPU acceleration.<br> Docker-based providers are downloaded & installed automatically on first use, you only need to have Docker Desktop installed.
...
| docker-demucs, dd              | good (9.9) | FREE | ———— |  |
