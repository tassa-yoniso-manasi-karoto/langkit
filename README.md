...
Additionally a **summary of the episode/media can be generated by an AI (LLM)** in your native language and embeded in the audiofile to refresh your memories before listening and help your understand the condensed audio's content. Openrouter serves a number of LLMs that can do this **for free** (Deepseek, Llama Maverik...).
...
**NOTE: don't rely on the Word Error Rate (WER) for all languages, check for your specific target language!**


| Provider   | Name (to be passed with --stt) | Num of lang supported (with WER<50%)                                                          | WER (ALL languages) (lower=better)                                                              | WER per language                                                               | Price         | Type   |
|------------|--------------------------------|-----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|---------------|--------|
