...
{#if isVisible}
    <a 
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 24 24" class="coffee-icon">
            <defs>
            ...
            <rect x="0" width="24" 
                  ...
                  height="0" 
                  y="7.5">
                <animate attributeName="y" dur="0.6s" values="7.5;0.5" fill="freeze" begin="0.2s"/>
                <animate attributeName="height" dur="0.6s" values="0;7" fill="freeze" begin="0.2s"/>
            </rect>

            <g fill="none" stroke="#6B7280" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                <path fill="url(#coffeeFillGradient)" fill-opacity="0" 
