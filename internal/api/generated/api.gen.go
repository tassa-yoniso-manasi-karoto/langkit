// langkit-api v1.0.0 0396eb0293a67d9d2f75efb31fad9f181af50e2e
// --
...
func WebRPCSchemaHash() string {
	return "0396eb0293a67d9d2f75efb31fad9f181af50e2e"
}
...
type SystemServiceClient interface {
	...
	// Get NVIDIA GPU information (VRAM, name, availability)
	GetNvidiaGPUInfo(ctx context.Context) (*NvidiaGPUInfo, error)
}
...
type ChangelogServiceClient interface {
	...
	GetChangelog(ctx context.Context, sinceVersion *string) (*ChangelogResponse, error)
	// Check if user has upgraded and should see changelog
	CheckUpgrade(ctx context.Context) (*UpgradeInfo, error)
	// Mark the current version as seen (updates lastSeenVersion)
	MarkVersionSeen(ctx context.Context) error
}

type ExpectationServiceClient interface {
	RunCheck(ctx context.Context, request *CheckRequest) (*ValidationReport, error)
	ListProfiles(ctx context.Context) ([]*ExpectationProfile, error)
	SaveProfile(ctx context.Context, profile *ExpectationProfile) error
...
type NvidiaGPUInfo struct {
	// Whether an NVIDIA GPU with drivers is detected
	Available bool `json:"available"`
	// GPU name (e.g., 'NVIDIA GeForce RTX 3080'), empty if not available
	Name string `json:"name"`
	// Total VRAM in MiB, 0 if not available
	VramMiB int64 `json:"vramMiB"`
}
...
type Settings struct {
	...
	// sampled or full
	IntegrityDecodeDepth string `json:"integrityDecodeDepth"`
	// consensus quorum threshold (50-100)
	PreflightQuorumPct int32 `json:"preflightQuorumPct"`
	// max minutes per segment to avoid GPU OOM
	DemucsMaxSegmentMinutes          int32            `json:"demucsMaxSegmentMinutes"`
	...
	// all, minor_major, major_only
	ChangelogDisplayFrequency string `json:"changelogDisplayFrequency"`
}
...
type ProcessRequest struct {
	...
	AcknowledgedSkips []*SkipEntry    `json:"acknowledgedSkips"`
}
...
type UpgradeInfo struct {
	...
	ShouldShowChangelog bool   `json:"shouldShowChangelog"`
}

type ExpectationProfile struct {
	Name                     string   `json:"name"`
	ExpectedAudioLangs       []string `json:"expectedAudioLangs"`
	ExpectedSubtitleLangs    []string `json:"expectedSubtitleLangs"`
	RequireVideoTrack        bool     `json:"requireVideoTrack"`
	RequireLanguageTags      bool     `json:"requireLanguageTags"`
	DurationTolerancePercent float64  `json:"durationTolerancePercent"`
	CheckExternalAudioFiles  bool     `json:"checkExternalAudioFiles"`
...
type AutoCheckConfig struct {
	...
	SoftFloorPct float64 `json:"softFloorPct"`
	MinGroupSize int32   `json:"minGroupSize"`
}

type CheckRequest struct {
	Path       string              `json:"path"`
	Profile    *ExpectationProfile `json:"profile"`
	AutoConfig *AutoCheckConfig    `json:"autoConfig"`
}
...
type DirectoryConsensusSummary struct {
	Directory                string   `json:"directory"`
	FileCount                int32    `json:"fileCount"`
	BonusExcluded            int32    `json:"bonusExcluded"`
	ConsensusAudioLangs      []string `json:"consensusAudioLangs"`
	ConsensusSubLangs        []string `json:"consensusSubLangs"`
	ConsensusAudioTrackCount int32    `json:"consensusAudioTrackCount"`
...
type ValidationReport struct {
	...
	InterpretedSummaries []*InterpretedSummary        `json:"interpretedSummaries"`
	ConsensusSummaries   []*DirectoryConsensusSummary `json:"consensusSummaries"`
	ErrorCount           int32                        `json:"errorCount"`
	WarningCount         int32                        `json:"warningCount"`
	InfoCount            int32                        `json:"infoCount"`
...
const ChangelogServicePathPrefix = "/rpc/ChangelogService/"
const ExpectationServicePathPrefix = "/rpc/ExpectationService/"
...
func (c *systemServiceClient) GetNvidiaGPUInfo(ctx context.Context) (*NvidiaGPUInfo, error) {
	out := struct {
		Ret0 *NvidiaGPUInfo `json:"info"`
	}{}
...
func NewChangelogServiceClient(addr string, client HTTPClient) ChangelogServiceClient {
	prefix := urlBase(addr) + ChangelogServicePathPrefix
	urls := [3]string{
		prefix + "GetChangelog",
		prefix + "CheckUpgrade",
		prefix + "MarkVersionSeen",
	}
...
func (c *changelogServiceClient) GetChangelog(ctx context.Context, sinceVersion *string) (*ChangelogResponse, error) {
	in := struct {
		Arg0 *string `json:"sinceVersion"`
	}{sinceVersion}
	out := struct {
		Ret0 *ChangelogResponse `json:"response"`
	}{}
...
func (c *changelogServiceClient) CheckUpgrade(ctx context.Context) (*UpgradeInfo, error) {
	out := struct {
		Ret0 *UpgradeInfo `json:"info"`
	}{}
...
func (c *changelogServiceClient) MarkVersionSeen(ctx context.Context) error {
	resp, err := doHTTPRequest(ctx, c.client, c.urls[2], nil, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func NewExpectationServiceClient(addr string, client HTTPClient) ExpectationServiceClient {
	prefix := urlBase(addr) + ExpectationServicePathPrefix
	urls := [4]string{
		prefix + "RunCheck",
		prefix + "ListProfiles",
		prefix + "SaveProfile",
	...
	return &expectationServiceClient{
		client: client,
		urls:   urls,
	}
}

func (c *expectationServiceClient) RunCheck(ctx context.Context, request *CheckRequest) (*ValidationReport, error) {
	in := struct {
		Arg0 *CheckRequest `json:"request"`
	}{request}
	out := struct {
		Ret0 *ValidationReport `json:"report"`
	}{}
...
func (c *expectationServiceClient) ListProfiles(ctx context.Context) ([]*ExpectationProfile, error) {
	out := struct {
		Ret0 []*ExpectationProfile `json:"profiles"`
	}{}
...
func (c *expectationServiceClient) SaveProfile(ctx context.Context, profile *ExpectationProfile) error {
	in := struct {
		Arg0 *ExpectationProfile `json:"profile"`
	}{profile}
...
func (c *expectationServiceClient) DeleteProfile(ctx context.Context, name string) error {
	in := struct {
...
func (s *systemServiceService) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/SystemService/GetNvidiaGPUInfo":
		handler = s.serveGetNvidiaGPUInfoJSON
	default:
		err := ErrWebrpcBadRoute.WithCausef("no webrpc method defined for path %v", r.URL.Path)
		s.sendErrorJSON(w, r, err)
		return
...
func (s *systemServiceService) serveGetNvidiaGPUInfoJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetNvidiaGPUInfo")

	// Call service method implementation.
	ret0, err := s.SystemServiceServer.GetNvidiaGPUInfo(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
type changelogServiceService struct {
	ChangelogServiceServer
	OnError   func(r *http.Request, rpcErr *WebRPCError)
	OnRequest func(w http.ResponseWriter, r *http.Request) error
}

func NewChangelogServiceServer(svc ChangelogServiceServer) *changelogServiceService {
	return &changelogServiceService{
		ChangelogServiceServer: svc,
	}
}

func (s *changelogServiceService) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
		// In case of a panic, serve a HTTP 500 error and then panic.
		if rr := recover(); rr != nil {
			s.sendErrorJSON(w, r, ErrWebrpcServerPanic.WithCausef("%v", rr))
	...
	ctx = context.WithValue(ctx, HTTPResponseWriterCtxKey, w)
	ctx = context.WithValue(ctx, HTTPRequestCtxKey, r)
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "ChangelogService")

	r = r.WithContext(ctx)

	var handler func(ctx context.Context, w http.ResponseWriter, r *http.Request)
	switch r.URL.Path {
	case "/rpc/ChangelogService/GetChangelog":
		handler = s.serveGetChangelogJSON
	case "/rpc/ChangelogService/CheckUpgrade":
		handler = s.serveCheckUpgradeJSON
	case "/rpc/ChangelogService/MarkVersionSeen":
		handler = s.serveMarkVersionSeenJSON
	default:
		err := ErrWebrpcBadRoute.WithCausef("no webrpc method defined for path %v", r.URL.Path)
		s.sendErrorJSON(w, r, err)
		return
...
func (s *changelogServiceService) serveGetChangelogJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetChangelog")
	...
	// Call service method implementation.
	ret0, err := s.ChangelogServiceServer.GetChangelog(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *changelogServiceService) serveCheckUpgradeJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "CheckUpgrade")

	// Call service method implementation.
	ret0, err := s.ChangelogServiceServer.CheckUpgrade(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *changelogServiceService) serveMarkVersionSeenJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "MarkVersionSeen")

	// Call service method implementation.
	err := s.ChangelogServiceServer.MarkVersionSeen(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *changelogServiceService) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		s.OnError(r, &rpcErr)
	}
...
type expectationServiceService struct {
	ExpectationServiceServer
	OnError   func(r *http.Request, rpcErr *WebRPCError)
	OnRequest func(w http.ResponseWriter, r *http.Request) error
}

func NewExpectationServiceServer(svc ExpectationServiceServer) *expectationServiceService {
	return &expectationServiceService{
		ExpectationServiceServer: svc,
	}
}

func (s *expectationServiceService) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
		// In case of a panic, serve a HTTP 500 error and then panic.
		if rr := recover(); rr != nil {
			s.sendErrorJSON(w, r, ErrWebrpcServerPanic.WithCausef("%v", rr))
	...
	ctx = context.WithValue(ctx, HTTPResponseWriterCtxKey, w)
	ctx = context.WithValue(ctx, HTTPRequestCtxKey, r)
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "ExpectationService")

	r = r.WithContext(ctx)

	var handler func(ctx context.Context, w http.ResponseWriter, r *http.Request)
	switch r.URL.Path {
	case "/rpc/ExpectationService/RunCheck":
		handler = s.serveRunCheckJSON
	case "/rpc/ExpectationService/ListProfiles":
		handler = s.serveListProfilesJSON
	case "/rpc/ExpectationService/SaveProfile":
		handler = s.serveSaveProfileJSON
	case "/rpc/ExpectationService/DeleteProfile":
		handler = s.serveDeleteProfileJSON
	default:
		err := ErrWebrpcBadRoute.WithCausef("no webrpc method defined for path %v", r.URL.Path)
		s.sendErrorJSON(w, r, err)
		return
...
func (s *expectationServiceService) serveRunCheckJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "RunCheck")
	...
	// Call service method implementation.
	ret0, err := s.ExpectationServiceServer.RunCheck(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *expectationServiceService) serveListProfilesJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListProfiles")

	// Call service method implementation.
	ret0, err := s.ExpectationServiceServer.ListProfiles(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *expectationServiceService) serveSaveProfileJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "SaveProfile")
	...
	// Call service method implementation.
	err = s.ExpectationServiceServer.SaveProfile(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *expectationServiceService) serveDeleteProfileJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "DeleteProfile")
	...
	// Call service method implementation.
	err = s.ExpectationServiceServer.DeleteProfile(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *expectationServiceService) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		s.OnError(r, &rpcErr)
	}
...
var methods = map[string]*method{
	...
	"/rpc/SystemService/GetNvidiaGPUInfo": {
		name:        "GetNvidiaGPUInfo",
		service:     "SystemService",
		annotations: map[string]string{},
	},
	...
	"/rpc/ChangelogService/GetChangelog": {
		name:        "GetChangelog",
		service:     "ChangelogService",
		annotations: map[string]string{},
	},
	"/rpc/ChangelogService/CheckUpgrade": {
		name:        "CheckUpgrade",
		service:     "ChangelogService",
		annotations: map[string]string{},
	},
	"/rpc/ChangelogService/MarkVersionSeen": {
		name:        "MarkVersionSeen",
		service:     "ChangelogService",
		annotations: map[string]string{},
	},
	"/rpc/ExpectationService/RunCheck": {
		name:        "RunCheck",
		service:     "ExpectationService",
		annotations: map[string]string{},
	},
	"/rpc/ExpectationService/ListProfiles": {
		name:        "ListProfiles",
		service:     "ExpectationService",
		annotations: map[string]string{},
	},
	"/rpc/ExpectationService/SaveProfile": {
		name:        "SaveProfile",
		service:     "ExpectationService",
		annotations: map[string]string{},
	},
	"/rpc/ExpectationService/DeleteProfile": {
		name:        "DeleteProfile",
		service:     "ExpectationService",
		annotations: map[string]string{},
	},
