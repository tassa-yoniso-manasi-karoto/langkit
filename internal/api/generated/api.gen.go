// langkit-api v1.0.0 794b038d0050616706ecd5030023db393f928337
// --
...
func WebRPCSchemaHash() string {
	return "794b038d0050616706ecd5030023db393f928337"
}
...
func (s *systemServiceServer) serveGetSystemInfoJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetSystemInfo")

	// Call service method implementation.
	ret0, err := s.SystemService.GetSystemInfo(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *systemServiceServer) serveGetVersionJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetVersion")

	// Call service method implementation.
	ret0, err := s.SystemService.GetVersion(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *systemServiceServer) serveCheckForUpdateJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "CheckForUpdate")

	// Call service method implementation.
	ret0, err := s.SystemService.CheckForUpdate(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *systemServiceServer) serveOpenURLJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	err = s.SystemService.OpenURL(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func NewMediaServiceServer(svc MediaService) *mediaServiceServer {
	return &mediaServiceServer{
		MediaService: svc,
	}
}

func (s *mediaServiceServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
		// In case of a panic, serve a HTTP 500 error and then panic.
		if rr := recover(); rr != nil {
			s.sendErrorJSON(w, r, ErrWebrpcServerPanic.WithCausef("%v", rr))
...
func (s *mediaServiceServer) serveOpenVideoDialogJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "OpenVideoDialog")

	// Call service method implementation.
	ret0, err := s.MediaService.OpenVideoDialog(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *mediaServiceServer) serveOpenDirectoryDialogJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "OpenDirectoryDialog")

	// Call service method implementation.
	ret0, err := s.MediaService.OpenDirectoryDialog(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *mediaServiceServer) serveOpenExecutableDialogJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.MediaService.OpenExecutableDialog(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *mediaServiceServer) serveGetVideosInDirectoryJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.MediaService.GetVideosInDirectory(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *mediaServiceServer) serveCheckMediaLanguageTagsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.MediaService.CheckMediaLanguageTags(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *mediaServiceServer) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		s.OnError(r, &rpcErr)
	}
...
type processingServiceServer struct {
	ProcessingService
	OnError   func(r *http.Request, rpcErr *WebRPCError)
	OnRequest func(w http.ResponseWriter, r *http.Request) error
}

func NewProcessingServiceServer(svc ProcessingService) *processingServiceServer {
	return &processingServiceServer{
		ProcessingService: svc,
	}
}

func (s *processingServiceServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
		// In case of a panic, serve a HTTP 500 error and then panic.
		if rr := recover(); rr != nil {
			s.sendErrorJSON(w, r, ErrWebrpcServerPanic.WithCausef("%v", rr))
...
func (s *processingServiceServer) serveSendProcessingRequestJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.ProcessingService.SendProcessingRequest(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *processingServiceServer) serveCancelProcessingJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "CancelProcessing")

	// Call service method implementation.
	err := s.ProcessingService.CancelProcessing(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *processingServiceServer) serveGetProcessingStatusJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetProcessingStatus")

	// Call service method implementation.
	ret0, err := s.ProcessingService.GetProcessingStatus(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *processingServiceServer) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		s.OnError(r, &rpcErr)
	}
