...
require (
	...
	github.com/tassa-yoniso-manasi-karoto/go-pythainlp v0.0.0-20251219122136-063165ab0170 // indirect
	github.com/tassa-yoniso-manasi-karoto/paiboonizer v0.0.0-20251219122236-6b2d2b470805 // indirect
